...
int Toy_hookAbout(Toy_Interpreter *interpreter, Toy_Literal identifier, Toy_Literal alias) {
    ...
    //store globally
        ...
        if (Toy_isDelcaredScopeVariable(interpreter->scope, majorKeyLiteral) || Toy_isDelcaredScopeVariable(interpreter->scope, minorKeyLiteral)
                || Toy_isDelcaredScopeVariable(interpreter->scope, patchKeyLiteral) || Toy_isDelcaredScopeVariable(interpreter->scope, buildKeyLiteral)
