...
static int nativeCeil(Toy_Interpreter *interpreter, Toy_LiteralArray *arguments) {
    ...
    if (TOY_IS_FLOAT(selfLiteral)) {
        result = TOY_TO_INTEGER_LITERAL(
                (int)TOY_AS_FLOAT(selfLiteral) - TOY_AS_FLOAT(selfLiteral) == 0 ? (int)TOY_AS_FLOAT(selfLiteral) : (int)TOY_AS_FLOAT(selfLiteral) + 1);
    }
...
static int nativeRound(Toy_Interpreter *interpreter, Toy_LiteralArray *arguments) {
    ...
    if (TOY_IS_FLOAT(selfLiteral)) {
        ...
        if (TOY_AS_FLOAT(selfLiteral) == (int) TOY_AS_FLOAT(selfLiteral)) {
            ...
            result = TOY_TO_INTEGER_LITERAL(
                    TOY_AS_FLOAT(selfLiteral) - (int)TOY_AS_FLOAT(selfLiteral) < 0.5 ? (int)TOY_AS_FLOAT(selfLiteral) : (int)TOY_AS_FLOAT(selfLiteral) + 1);
        }
    }
    ...
    if (TOY_IS_DICTIONARY(selfLiteral)) {
        ...
        for (int i = 0; i < TOY_AS_DICTIONARY(selfLiteral)->capacity; i++) {
            if (!TOY_IS_NULL(TOY_AS_DICTIONARY(selfLiteral)->entries[i].key)) {
                Toy_setLiteralDictionary(TOY_AS_DICTIONARY(otherLiteral), TOY_AS_DICTIONARY(selfLiteral)->entries[i].key,
                        TOY_AS_DICTIONARY(selfLiteral)->entries[i].value);
            }
        }
...
static int nativeContainsValue(Toy_Interpreter *interpreter, Toy_LiteralArray *arguments) {
    ...
    if (TOY_IS_DICTIONARY(selfLiteral)) {
        for (int i = 0; i < TOY_AS_DICTIONARY(selfLiteral)->capacity; i++) {
            if (!TOY_IS_NULL(TOY_AS_DICTIONARY(selfLiteral)->entries[i].key)
                    && Toy_literalsAreEqual( TOY_AS_DICTIONARY(selfLiteral)->entries[i].value, valueLiteral)) {
...
int Toy_hookStandard(Toy_Interpreter *interpreter, Toy_Literal identifier, Toy_Literal alias) {
    ...
    Natives natives[] = {
    //misc. utils
            { "clock", nativeClock }, { "hash", nativeHash },

            //math utils
            { "abs", nativeAbs }, { "ceil", nativeCeil }, { "floor", nativeFloor }, { "max", nativeMax }, { "min", nativeMin }, { "round", nativeRound },
